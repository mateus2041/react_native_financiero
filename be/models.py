...
class Administradores(Base):
    ...
    correo = Column(String(100), unique=True, nullable=False)
    contraseña = Column(String(255), nullable=False)
    rol = Column(String(50), default="supervisor")
...
class Tokens(Base):
    ...
    token_valor = Column(String(255), nullable=False)
    tipo_token = Column(String(50))
...
class Debito(Base):
    ...
    id_debito = Column(Integer, primary_key=True, autoincrement=True)
